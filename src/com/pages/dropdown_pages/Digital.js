                ...
                <div className="container">
                    <div className="about_row">
                        ...
                        <div className="about_details" data-aos="fade-left"
                            ...
                            <p style={{textAlign:"justify"}}>Our digital marketing course covers SEO, social media marketing, email marketing, and more, equipping you with the tools to succeed in the competitive online landscape.</p>
